...
from .views import hello, predict_cluster, login_view, success_view, specialties_pie_chart_view, get_reports_by_cluster,get_reports_by_clusters_and_specialties
...
urlpatterns = [
    ...
    path('get_reports_by_clusters_and_specialties/', get_reports_by_clusters_and_specialties, name='get_reports_by_clusters_and_specialties/'),   ]

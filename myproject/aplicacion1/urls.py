...
from .views import hello, predict_cluster, login_view, success_view, specialties_pie_chart_view, get_reports_by_cluster,get_reports_by_clusters_specialty
...
urlpatterns = [
    ...
    path('get_reports_by_clusters_specialty/', get_reports_by_clusters_specialty, name='get_reports_by_clusters_specialty'),   ]
